...
var style_GISMMPTitikTestPit_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = [ new ol.style.Style({
        ...
        image: new ol.style.Circle({radius: 1.1375 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(255,2,2,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.52}), fill: new ol.style.Fill({color: 'rgba(255,0,0,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
